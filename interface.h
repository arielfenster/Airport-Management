...
class Ex2 {
public:
    virtual Employee *addEmployee(int seniority, int birthYear, string employer_id, Jobs title) = 0;

    virtual Employee *getEmployee(string id) = 0;

    virtual Plane *addPlane(int model_number, map<Jobs, int> crew_needed, map<Classes, int> max_passengers) = 0;
